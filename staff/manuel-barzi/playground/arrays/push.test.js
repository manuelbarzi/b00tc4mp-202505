...
console.info('CASE adds element to array')

{
    ...
    console.assert(nums[nums.length - 1] === 40, 'nums at last index is 40')
}

console.info('CASE adds elements to array')

{
    ...
    console.assert(nums[nums.length - 2] === 40, 'nums at before index last is 40')
    console.assert(nums[nums.length - 1] === 50, 'nums at before index last is 50')
}
